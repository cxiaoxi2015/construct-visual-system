(function (root, factory) {
    ...
    if (!echarts.registerMap) {
        log('ECharts mapJson is not loaded')
        return;
    }
    echarts.registerMap('china', {
        ...
        "features": [{
            ...
            }, "properties": {"cp": [115.670801, 43.818311], "name": "内蒙古自治区", "childNum": 2}
        }, {
            ...
            }, "properties": {"cp": [96.778916, 35.623178], "name": "青海省", "childNum": 2}
        }, {
            "id": "640000",
            "type": "Feature",
            "geometry": {
            ...
            "properties": {"cp": [106.278179, 38.46637], "name": "宁夏自治区", "childNum": 2}
        }, {
            ...
            }, "properties": {"cp": [87.617733, 42.792818], "name": "新疆维吾尔自治区", "childNum": 1}
        }, {
            "id": "110000",
            "type": "Feature",
            "geometry": {
            ...
            "properties": {"cp": [118.100182, 38.425596], "name": "天津市", "childNum": 1}
        }, {
            "id": "310000",
            "type": "Feature",
            "geometry": {
            ...
            "properties": {"cp": [106.504962, 29.533155], "name": "新疆兵团", "childNum": 2}
        }],
        "UTF8Encoding": true
    });
}));
